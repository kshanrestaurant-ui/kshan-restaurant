...
const menuItems = {
  ...
  Sea_main: [
    ...
    { name: "Pomfret Curry", price: "655", type: "non-veg" },
    { name: "Pomfret Green Masala", price: "695", type: "non-veg" },
    { name: "Surmai Masala", price: "570", type: "non-veg" },
    { name: "Surmai Curry", price: "550", type: "non-veg" },
    { name: "Prawns Masala", price: "530", type: "non-veg" },
    { name: "Prawns curry", price: "520", type: "non-veg" },
